...
namespace Programacion8vo.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var json = await api.GetStringAsync("https://localhost:7047/ListClientes/");
        ...
        {
            var api = new HttpClient();
            var json = await api.GetStringAsync("https://localhost:7047/clientes/" + id);
        ...
        public ActionResult Edit(int id, Models.clienteModel cliente)
        {
            ...
            var data = new StringContent(json, Encoding.UTF8, "Application/json");
            var api = new HttpClient();
            var response = api.PostAsync("https://localhost:7279/clientes/", data);
